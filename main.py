...
ignx = input("Input the MCPE player name to search (Each divided by comma): ")
...
for ign in result:
    ...
    if r.status_code != 200:
        ...
        try:
            ...
            print(
                "\nAPI returned with a blank json. You might wanna check if the player exist. Skipping..."
            )
            continue
